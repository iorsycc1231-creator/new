      ...
      body: JSON.stringify({
        ...
        messages: [{
          ...
          content: [
            ...
            { type: 'text', text: 'レシートを解析してJSONのみ返してください。{"store_name":"店名","invoice_number":"T番号またはなし","date":"YYYY-MM-DD","items":[{"name":"商品名","amount":数値,"tax_category":"10%標準または8%軽減または非課税"}],"tax_8":数値orNull,"tax_10":数値orNull,"total":数値orNull}' }
          ]
        }]
      })
    });
